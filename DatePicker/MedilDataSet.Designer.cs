...
SELECT Id, Date_of_Creation, Patient_Id, Patient_Name, Age FROM Reports WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DatePicker.Properties.Settings.Default.MedilConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        Age, Date_of_Creation, Id, Patient_Id, Patient_Name\r\nFROM          " +
                "  Reports\r\nWHERE        (Patient_Name = @Param1)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Param1", global::System.Data.SqlDbType.VarChar, 200, global::System.Data.ParameterDirection.Input, 0, 0, "Patient_Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByPatient(MedilDataSet.ReportsDataTable dataTable, string Param1) {
        ...
        public virtual MedilDataSet.ReportsDataTable GetDataBy(string Param1) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Param1 == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
